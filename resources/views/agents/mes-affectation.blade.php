...
@section('content')
    @include('partials.breadcump', ['titre' => "Mes affectations", 'titre2' => "Mes affectations"])
            ...
            <x-header-page>
                ...
                <x-slot name="right">
                    <div class="flex gap-4 text-gray-600 dark:text-white">
                        {{ count($list_affectation) }} Affectations
                    </div>
                </x-slot>
            </x-header-page>
            {{-- table --}}
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    @else
                        <div id="alert-border-1"
                            ...
                            <div class="ms-3 text-sm font-medium">Vous n'etes pas encore affecter. Veuillez contacter
